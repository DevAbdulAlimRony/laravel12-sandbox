...
$adjusted = Str::finish('this/string', '/'); // Adds a single instance of the given value to a string if it does not already end with that value
...
// Truncate String
$excerpt = Str::excerpt('This is my name', 'my', ['radius' => 3]); // Output: '...is my na...' we got three dots before and after and truncate.
// By default radius is 100
$excerpt = Str::excerpt('This is my name', 'name', ['radius' => 3, 'omission' => '(...) ']); // '(...) my name'

$decoded = Str::fromBase64('TGFyYXZlbA=='); // Laravel. Decode a base64 to a string.
